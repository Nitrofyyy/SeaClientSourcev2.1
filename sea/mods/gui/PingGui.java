...
public class PingGui extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawRect(34, 65, PingGui.width - 23, sr.getScaledHeight() - 0, new Color(0, 0, 204, 100).getRGB());
        this.mc.getTextureManager().bindTexture(PingGui.CLICK_GUI);
        Gui.drawModalRectWithCustomSizedTexture(-8, 0, 0.0f, 0.0f, PingGui.width + 20, PingGui.height + 20, (float)(PingGui.width + 20), (float)(PingGui.height + 20));
        ...
        FontUtils.normal.drawCenteredString("Ping Settings", 118.0f, 13.0f, -1);
    ...
    public void initGui() {
        ...
        modButtons.add(new ModButton(x, y, w, h, Settings.ping1));
        ...
        modButtons2.add(new ModButton(x2, y2, w2, h2, Settings.ping2));
        ...
        modButtons3.add(new ModButton(x3, y3, w3, h3, Settings.ping3));
        ...
        modButtons4.add(new ModButton(x4, y4, w4, h4, Settings.pingnobg));
        super.initGui();
    }
