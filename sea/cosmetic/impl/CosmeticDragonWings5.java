...
public class CosmeticDragonWings5 extends CosmeticBase
{
    ...
    public CosmeticDragonWings5(final RenderPlayer renderPlayer) {
        super(renderPlayer);
        this.flying = false;
        ...
        (CosmeticDragonWings5.wing = new ModelRenderer(this.modelDragonWings, "wing")).setRotationPoint(-12.0f, 5.0f, 2.0f);
        CosmeticDragonWings5.wing.addBox("bone", -56.0f, -4.0f, -4.0f, 56, 8, 8);
        CosmeticDragonWings5.wing.addBox("skin", -56.0f, 0.0f, 2.0f, 56, 0, 56);
        CosmeticDragonWings5.wing.isHidden = true;
        (CosmeticDragonWings5.wingTip = new ModelRenderer(this.modelDragonWings, "wingTip")).setRotationPoint(-56.0f, 0.0f, 0.0f);
        CosmeticDragonWings5.wingTip.isHidden = true;
        CosmeticDragonWings5.wingTip.addBox("bone", -56.0f, -2.0f, -2.0f, 56, 4, 4);
        CosmeticDragonWings5.wingTip.addBox("skin", -56.0f, 0.0f, 2.0f, 56, 0, 56);
        CosmeticDragonWings5.wing.addChild(CosmeticDragonWings5.wingTip);
    ...
    public void render(final AbstractClientPlayer player, final float limbSwing, final float limbSwingAmount, final float partialTicks, final float ageInTicks, final float HeadYaw, final float headPitch, final float scale) {
        if (CosmeticBoolean.isDragonWings5() && player.getName().equals(Minecraft.getMinecraft().getSession().getUsername())) {
    ...
    private class ModelDragonWings extends CosmeticModelBase
    {
        ...
        public void render(final Entity entityIn, final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch, final float scale) {
            ...
            if (entityIn.getName().equals(Minecraft.getMinecraft().getSession().getUsername())) {
                ...
                Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("textures/seaclient/wings/wings5.png"));
                float anSpeed = 100.0f;
                if (!entityIn.onGround || CosmeticDragonWings5.this.flying) {
                    anSpeed = 50.0f;
                    CosmeticDragonWings5.this.flying = true;
                }
                ...
                for (int i = 0; i < 2; ++i) {
                    ...
                    CosmeticDragonWings5.wing.rotateAngleX = 0.125f - (float)Math.cos(f2) * 0.2f;
                    CosmeticDragonWings5.wing.rotateAngleY = 0.25f;
                    CosmeticDragonWings5.wing.rotateAngleZ = (float)(Math.sin(f2) + 1.225) * 0.3f;
                    CosmeticDragonWings5.wingTip.rotateAngleZ = -(float)(Math.sin(f2 + 2.0f) + 0.5) * 0.75f;
                    CosmeticDragonWings5.wing.isHidden = false;
                    CosmeticDragonWings5.wingTip.isHidden = false;
                    if (!entityIn.isInvisible()) {
                        GlStateManager.pushMatrix();
                        GlStateManager.disableLighting();
                        CosmeticDragonWings5.wing.render(scale);
