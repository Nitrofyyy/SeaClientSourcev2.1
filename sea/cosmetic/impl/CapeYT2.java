...
public class CapeYT2 implements LayerRenderer<AbstractClientPlayer>
{
    ...
    static {
        CapeYT2.CAPE = new ResourceLocation("textures/seaclient/cape/capeYT1.png");
    }
    
    public CapeYT2(final RenderPlayer playerRendererIn) {
    ...
    public void doRenderLayer(final AbstractClientPlayer entitylivingbaseIn, final float p_177141_2_, final float p_177141_3_, final float partialTicks, final float p_177141_5_, final float p_177141_6_, final float p_177141_7_, final float scale) {
        if (CosmeticBoolean.Cape1() && entitylivingbaseIn.hasPlayerInfo() && !entitylivingbaseIn.isInvisible() && entitylivingbaseIn.isWearing(EnumPlayerModelParts.CAPE) && entitylivingbaseIn.getName().equals("RazerGamezYT") && entitylivingbaseIn.getName().equals("RazerGamezYT")) {
            GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
            this.playerRenderer.bindTexture(CapeYT2.CAPE);
