...
public class Chunk
{
    ...
    private static final ChunkPregenerator chunkpreg;
    ...
    static {
        ...
        chunkpreg = new ChunkPregenerator();
    }
    
    public Chunk(final World worldIn, final int x, final int z, ChunkPregenerator chunk) {
        chunk = Chunk.chunkpreg;
    ...
    public Chunk(final World worldIn, final ChunkPrimer primer, final int x, final int z) {
        this(worldIn, x, z, Chunk.chunkpreg);
        final int i = 256;
