...
public class WorldInfo
{
    ...
    public void setWorldTime(final long time) {
        if (Settings.getTime1().isEnabled() && HudList.getTimechanger().isEnabled()) {
            this.worldTime = 0L;
            final Settings settings = SeaClient.getINSTANCE().settings;
            Settings.time2.setEnabled(false);
            final Settings settings2 = SeaClient.getINSTANCE().settings;
            Settings.time3.setEnabled(false);
        }
        else if (Settings.getTime2().isEnabled() && HudList.getTimechanger().isEnabled()) {
            this.worldTime = -1500L;
            final Settings settings3 = SeaClient.getINSTANCE().settings;
            Settings.time1.setEnabled(false);
            final Settings settings4 = SeaClient.getINSTANCE().settings;
            Settings.time3.setEnabled(false);
        }
        else if (Settings.getTime3().isEnabled() && HudList.getTimechanger().isEnabled()) {
            this.worldTime = 15000L;
            final Settings settings5 = SeaClient.getINSTANCE().settings;
            Settings.time1.setEnabled(false);
            final Settings settings6 = SeaClient.getINSTANCE().settings;
            Settings.time2.setEnabled(false);
        }
        else {
            this.worldTime = time;
            this.worldTime = 0L;
            final Settings settings7 = SeaClient.getINSTANCE().settings;
            Settings.time1.setEnabled(false);
            final Settings settings8 = SeaClient.getINSTANCE().settings;
            Settings.time2.setEnabled(false);
            final Settings settings9 = SeaClient.getINSTANCE().settings;
            Settings.time3.setEnabled(false);
        }
    }
