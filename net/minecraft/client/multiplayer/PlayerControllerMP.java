...
public class PlayerControllerMP
{
    ...
    public float getBlockReachDistance() {
        return (this.currentGameType.isCreative() && this.currentGameType.isSurvivalOrAdventure()) ? 5.0f : 4.5f;
    }
    ...
    public void attackEntity(final EntityPlayer playerIn, final Entity targetEntity) {
        ...
        final AttackEntityEvent event = new AttackEntityEvent(playerIn, targetEntity);
        event.call();
    }
