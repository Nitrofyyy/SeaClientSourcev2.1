...
public abstract class ResourcePackListEntry implements GuiListExtended.IGuiListEntry
{
    ...
    public void drawEntry(final int slotIndex, final int x, final int y, final int listWidth, final int slotHeight, final int mouseX, final int mouseY, final boolean isSelected) {
        ...
        final int i2 = Minecraft.fontRendererObj.getStringWidth(s);
        if (i2 > 157) {
            s = String.valueOf(Minecraft.fontRendererObj.trimStringToWidth(s, 157 - Minecraft.fontRendererObj.getStringWidth("..."))) + "...";
        }
        Minecraft.fontRendererObj.drawStringWithShadow(s, (float)(x + 32 + 2), (float)(y + 1), 16777215);
        final List<String> list = Minecraft.fontRendererObj.listFormattedStringToWidth(s2, 157);
        for (int l = 0; l < 2 && l < list.size(); ++l) {
            Minecraft.fontRendererObj.drawStringWithShadow(list.get(l), (float)(x + 32 + 2), (float)(y + 12 + 10 * l), 8421504);
        }
    }
