...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void orientCamera(final float partialTicks) {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping()) {
            ...
            if (!this.mc.gameSettings.debugCamEnable) {
                ...
                GlStateManager.rotate(ModList.getPerspective().getCameraYaw() + (ModList.getPerspective().getCameraYaw() - ModList.getPerspective().getCameraYaw()) * partialTicks + 180.0f, 0.0f, -1.0f, 0.0f);
                GlStateManager.rotate(ModList.getPerspective().getCameraPitch() + (ModList.getPerspective().getCameraPitch() - ModList.getPerspective().getCameraPitch()) * partialTicks, -1.0f, 0.0f, 0.0f);
            }
        }
            ...
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                final float f2 = ModList.getPerspective().getCameraYaw();
                float f3 = ModList.getPerspective().getCameraPitch();
                ...
                GlStateManager.rotate(ModList.getPerspective().getCameraPitch() - f3, 1.0f, 0.0f, 0.0f);
                GlStateManager.rotate(ModList.getPerspective().getCameraYaw() - f2, 0.0f, 1.0f, 0.0f);
                GlStateManager.translate(0.0f, 0.0f, (float)(-d4));
                GlStateManager.rotate(f2 - ModList.getPerspective().getCameraYaw(), 0.0f, 1.0f, 0.0f);
                GlStateManager.rotate(f3 - ModList.getPerspective().getCameraPitch(), 1.0f, 0.0f, 0.0f);
            }
        }
        else {
        ...
        if (Reflector.EntityViewRenderEvent_CameraSetup_Constructor.exists()) {
            if (!this.mc.gameSettings.debugCamEnable) {
                float f7 = ModList.getPerspective().getCameraYaw() + (ModList.getPerspective().getCameraYaw() - ModList.getPerspective().getCameraYaw()) * partialTicks + 180.0f;
                float f8 = ModList.getPerspective().getCameraPitch() + (ModList.getPerspective().getCameraPitch() - ModList.getPerspective().getCameraPitch()) * partialTicks;
                float f9 = 0.0f;
    ...
    public void updateCameraAndRender(final float partialTicks, final long nanoTime) {
        ...
        if (this.mc.inGameHasFocus && flag && ModList.getPerspective().overrideMouse()) {
