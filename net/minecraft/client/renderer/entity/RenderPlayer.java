...
import sea.cosmetic.impl.CosmeticHalo2;
import sea.cosmetic.impl.CosmeticHalo;
import sea.cosmetic.impl.Skine;
import sea.cosmetic.impl.CosmeticDragonWings6;
import sea.cosmetic.impl.CosmeticDragonWings5;
import sea.cosmetic.impl.CosmeticDragonWings4;
import sea.cosmetic.impl.CosmeticDragonWings3;
import sea.cosmetic.impl.CosmeticDragonWings2;
import sea.cosmetic.impl.CosmeticDragonWings;
import sea.cosmetic.impl.CapeYT2;
import sea.cosmetic.impl.CapeYT;
import net.minecraft.client.renderer.entity.layers.LayerCustomHead;
import sea.cosmetic.impl.SkyCape;
import sea.cosmetic.impl.SnowCape;
import sea.cosmetic.impl.CapeRick;
...
public class RenderPlayer extends RendererLivingEntity<AbstractClientPlayer>
{
    ...
    public RenderPlayer(final RenderManager renderManager, final boolean useSmallArms) {
        ...
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new CapeRick(this));
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new SnowCape(this));
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new SkyCape(this));
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new LayerCustomHead(this.getMainModel().bipedHead));
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new CapeYT(this));
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new CapeYT2(this));
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new CosmeticDragonWings(this));
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new CosmeticDragonWings2(this));
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new CosmeticDragonWings3(this));
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new CosmeticDragonWings4(this));
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new CosmeticDragonWings5(this));
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new CosmeticDragonWings6(this));
        ...
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new CosmeticHalo2(this));
    }
