...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener
{
    ...
    public void renderEntities(final Entity renderViewEntity, final ICamera camera, final float partialTicks) {
        ...
        if (this.renderEntitiesStartupCounter > 0) {
            ...
            TileEntityRendererDispatcher.instance.cacheActiveRenderInfo(this.theWorld, this.mc.getTextureManager(), Minecraft.fontRendererObj, this.mc.getRenderViewEntity(), partialTicks);
    ...
    public void drawSelectionBox(final EntityPlayer player, final MovingObjectPosition movingObjectPositionIn, final int execute, final float partialTicks) {
        if (execute == 0 && movingObjectPositionIn.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            else if (ColorList.getBlockyellow().isEnabled() && HudList.getBlockoverlay().isEnabled()) {
                final ColorList colorList5 = SeaClient.INSTANCE.colorList;
                ColorList.blockgreen.setEnabled(false);
                final ColorList colorList6 = SeaClient.INSTANCE.colorList;
                ColorList.blockblue.setEnabled(false);
                final ColorList colorList7 = SeaClient.INSTANCE.colorList;
                ColorList.blockpink.setEnabled(false);
                final ColorList colorList8 = SeaClient.INSTANCE.colorList;
                ColorList.blockwhite.setEnabled(false);
                final ColorList colorList9 = SeaClient.INSTANCE.colorList;
                ColorList.blockaqua.setEnabled(false);
                GlStateManager.enableBlend();
                GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
                GlStateManager.color(255.0f, 255.0f, 0.0f);
                GL11.glLineWidth(5.0f);
                GlStateManager.disableTexture2D();
            }
            else if (ColorList.getBlockblue().isEnabled() && HudList.getBlockoverlay().isEnabled()) {
                final ColorList colorList10 = SeaClient.INSTANCE.colorList;
                ColorList.blockgreen.setEnabled(false);
                final ColorList colorList11 = SeaClient.INSTANCE.colorList;
                ColorList.blockyellow.setEnabled(false);
                final ColorList colorList12 = SeaClient.INSTANCE.colorList;
                ColorList.blockpink.setEnabled(false);
                final ColorList colorList13 = SeaClient.INSTANCE.colorList;
                ColorList.blockaqua.setEnabled(false);
                final ColorList colorList14 = SeaClient.INSTANCE.colorList;
                ColorList.blockwhite.setEnabled(false);
                GlStateManager.enableBlend();
                GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
                GlStateManager.color(0.0f, 0.0f, 204.0f);
                GL11.glLineWidth(5.0f);
                GlStateManager.disableTexture2D();
            }
            else if (ColorList.getBlockgreen().isEnabled() && HudList.getBlockoverlay().isEnabled()) {
                final ColorList colorList15 = SeaClient.INSTANCE.colorList;
                ColorList.blockblue.setEnabled(false);
                final ColorList colorList16 = SeaClient.INSTANCE.colorList;
                ColorList.blockyellow.setEnabled(false);
                final ColorList colorList17 = SeaClient.INSTANCE.colorList;
                ColorList.blockpink.setEnabled(false);
                final ColorList colorList18 = SeaClient.INSTANCE.colorList;
                ColorList.blockaqua.setEnabled(false);
                final ColorList colorList19 = SeaClient.INSTANCE.colorList;
                ColorList.blockwhite.setEnabled(false);
                GlStateManager.enableBlend();
                GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
                GlStateManager.color(0.0f, 204.0f, 0.0f);
                GL11.glLineWidth(5.0f);
                GlStateManager.disableTexture2D();
            }
            else if (ColorList.getBlockpink().isEnabled() && HudList.getBlockoverlay().isEnabled()) {
                final ColorList colorList20 = SeaClient.INSTANCE.colorList;
                ColorList.blockgreen.setEnabled(false);
                final ColorList colorList21 = SeaClient.INSTANCE.colorList;
                ColorList.blockblue.setEnabled(false);
                final ColorList colorList22 = SeaClient.INSTANCE.colorList;
                ColorList.blockyellow.setEnabled(false);
                final ColorList colorList23 = SeaClient.INSTANCE.colorList;
                ColorList.blockwhite.setEnabled(false);
                final ColorList colorList24 = SeaClient.INSTANCE.colorList;
                ColorList.blockaqua.setEnabled(false);
                GlStateManager.enableBlend();
                GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
                GlStateManager.color(102.0f, 0.0f, 153.0f);
                GL11.glLineWidth(5.0f);
                GlStateManager.disableTexture2D();
            }
            else if (ColorList.getBlockwhite().isEnabled()) {
                final ColorList colorList25 = SeaClient.INSTANCE.colorList;
                ColorList.blockgreen.setEnabled(false);
                final ColorList colorList26 = SeaClient.INSTANCE.colorList;
                ColorList.blockblue.setEnabled(false);
                final ColorList colorList27 = SeaClient.INSTANCE.colorList;
                ColorList.blockyellow.setEnabled(false);
                final ColorList colorList28 = SeaClient.INSTANCE.colorList;
                ColorList.blockpink.setEnabled(false);
                final ColorList colorList29 = SeaClient.INSTANCE.colorList;
                ColorList.blockaqua.setEnabled(false);
                GlStateManager.enableBlend();
                GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
            ...
            else if (HudList.getBlockoverlay().isDisabled()) {
                final ColorList colorList30 = SeaClient.INSTANCE.colorList;
                ColorList.blockwhite.setEnabled(false);
                final ColorList colorList31 = SeaClient.INSTANCE.colorList;
                ColorList.blockgreen.setEnabled(false);
                final ColorList colorList32 = SeaClient.INSTANCE.colorList;
                ColorList.blockblue.setEnabled(false);
                final ColorList colorList33 = SeaClient.INSTANCE.colorList;
                ColorList.blockyellow.setEnabled(false);
                final ColorList colorList34 = SeaClient.INSTANCE.colorList;
                ColorList.blockpink.setEnabled(false);
                final ColorList colorList35 = SeaClient.INSTANCE.colorList;
                ColorList.blockaqua.setEnabled(false);
            }
            else {
                GlStateManager.enableBlend();
