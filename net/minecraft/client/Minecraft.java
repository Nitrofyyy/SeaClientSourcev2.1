...
import pregenerator.impl.client.PregenClientProxy;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public String debug;
    public PregenClientProxy pregen;
    ...
    private void startGame() throws LWJGLException, IOException {
        this.pregen = new PregenClientProxy();
        ...
        Minecraft.fontRendererObj = new FontRenderer(this.gameSettings, new ResourceLocation("textures/font/ascii.png"), this.renderEngine, false);
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("Starting " + SeaClient.nameverplusauthor);
        try {
    ...
    public void shutdownMinecraftApplet() {
        try {
            SeaClient.getINSTANCE().shutdown();
    ...
    private void displayDebugInfo(final long elapsedTicksTime) {
        if (this.mcProfiler.profilingEnabled) {
            ...
            Minecraft.fontRendererObj.drawStringWithShadow(s, (float)(j - i), (float)(k - i / 2 - 16), l3);
            Minecraft.fontRendererObj.drawStringWithShadow(s = String.valueOf(decimalformat.format(profiler$result.field_76330_b)) + "%", (float)(j + i - Minecraft.fontRendererObj.getStringWidth(s)), (float)(k - i / 2 - 16), l3);
            for (int k3 = 0; k3 < list.size(); ++k3) {
                ...
                Minecraft.fontRendererObj.drawStringWithShadow(s2, (float)(j - i), (float)(k + i / 2 + k3 * 8 + 20), profiler$result3.getColor());
                Minecraft.fontRendererObj.drawStringWithShadow(s2 = String.valueOf(decimalformat.format(profiler$result3.field_76332_a)) + "%", (float)(j + i - 50 - Minecraft.fontRendererObj.getStringWidth(s2)), (float)(k + i / 2 + k3 * 8 + 20), profiler$result3.getColor());
                Minecraft.fontRendererObj.drawStringWithShadow(s2 = String.valueOf(decimalformat.format(profiler$result3.field_76330_b)) + "%", (float)(j + i - Minecraft.fontRendererObj.getStringWidth(s2)), (float)(k + i / 2 + k3 * 8 + 20), profiler$result3.getColor());
            }
        }
    }
    ...
    public void runTick() throws IOException {
        ...
        final ClientTickEvent event2 = new ClientTickEvent();
        event2.call();
        this.mcProfiler.endSection();
        this.systemTime = getSystemTime();
    }
    ...
    public void loadWorld(final WorldClient worldClientIn, final String loadingMessage) {
        final EntityJoinWorldEvent event = new EntityJoinWorldEvent(this.pointedEntity, worldClientIn);
        event.call();
