...
public class GuiKeyBindingList extends GuiListExtended
{
    ...
    public GuiKeyBindingList(final GuiControls controls, final Minecraft mcIn) {
        ...
        for (int length = (array = akeybinding).length, k = 0; k < length; ++k) {
            ...
            final int j = Minecraft.fontRendererObj.getStringWidth(I18n.format(keybinding.getKeyDescription(), new Object[0]));
    ...
    public class CategoryEntry implements IGuiListEntry
    {
        ...
        public void drawEntry(final int slotIndex, final int x, final int y, final int listWidth, final int slotHeight, final int mouseX, final int mouseY, final boolean isSelected) {
            ...
            fontRendererObj.drawString(labelText, GuiScreen.width / 2 - this.labelWidth / 2, y + slotHeight - Minecraft.fontRendererObj.FONT_HEIGHT - 1, 16777215);
        }
    ...
    public class KeyEntry implements IGuiListEntry
    {
        ...
        public void drawEntry(final int slotIndex, final int x, final int y, final int listWidth, final int slotHeight, final int mouseX, final int mouseY, final boolean isSelected) {
            ...
            Minecraft.fontRendererObj.drawString(this.keyDesc, x + 90 - GuiKeyBindingList.this.maxListLabelWidth, y + slotHeight / 2 - Minecraft.fontRendererObj.FONT_HEIGHT / 2, 16777215);
