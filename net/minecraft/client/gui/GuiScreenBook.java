...
public class GuiScreenBook extends GuiScreen
{
    ...
    public IChatComponent func_175385_b(final int p_175385_1_, final int p_175385_2_) {
        ...
        if (i <= 116 && j < Minecraft.fontRendererObj.FONT_HEIGHT * k + k) {
            final int l = j / Minecraft.fontRendererObj.FONT_HEIGHT;
            if (l >= 0 && l < this.field_175386_A.size()) {
                ...
                for (final IChatComponent ichatcomponent2 : ichatcomponent) {
                    if (ichatcomponent2 instanceof ChatComponentText) {
                        i2 += Minecraft.fontRendererObj.getStringWidth(((ChatComponentText)ichatcomponent2).getChatComponentText_TextValue());
                        if (i2 > i) {
