...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui() {
        ...
        SeaClient.getINSTANCE().getDiscord().update("Idle at Multiplayer Menu", "IGN: " + Minecraft.getMinecraft().getSession().getProfile().getName());
        this.createButtons();
    }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        FontUtils.normal.drawCenteredString(I18n.format("multiplayer.title", new Object[0]), (float)(GuiMultiplayer.width / 2), 20.0f, 16777215);
