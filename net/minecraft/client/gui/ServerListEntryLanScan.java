...
public class ServerListEntryLanScan implements GuiListExtended.IGuiListEntry
{
    ...
    public void drawEntry(final int slotIndex, final int x, final int y, final int listWidth, final int slotHeight, final int mouseX, final int mouseY, final boolean isSelected) {
        final int i = y + slotHeight / 2 - Minecraft.fontRendererObj.FONT_HEIGHT / 2;
        ...
        fontRendererObj.drawString(format, GuiScreen.width / 2 - Minecraft.fontRendererObj.getStringWidth(I18n.format("lanServer.scanning", new Object[0])) / 2, i, 16777215);
        String s = null;
        ...
        fontRendererObj2.drawString(text, GuiScreen.width / 2 - Minecraft.fontRendererObj.getStringWidth(s) / 2, i + Minecraft.fontRendererObj.FONT_HEIGHT, 8421504);
    }
