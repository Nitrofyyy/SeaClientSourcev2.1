...
public class GuiScreenResourcePacks extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawCenteredString(this.fontRendererObj, I18n.format("resourcePack.title", new Object[0]), (float)(GuiScreenResourcePacks.width / 2), 16.0f, 16777215);
        Gui.drawCenteredString(this.fontRendererObj, I18n.format("resourcePack.folderInfo", new Object[0]), (float)(GuiScreenResourcePacks.width / 2 - 77), (float)(GuiScreenResourcePacks.height - 26), 8421504);
