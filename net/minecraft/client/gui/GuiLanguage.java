...
public class GuiLanguage extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawCenteredString(this.fontRendererObj, I18n.format("options.language", new Object[0]), (float)(GuiLanguage.width / 2), 16.0f, 16777215);
        Gui.drawCenteredString(this.fontRendererObj, "(" + I18n.format("options.languageWarning", new Object[0]) + ")", (float)(GuiLanguage.width / 2), (float)(GuiLanguage.height - 56), 8421504);
    ...
    class List extends GuiSlot
    {
        ...
        protected void drawSlot(final int entryID, final int p_180791_2_, final int p_180791_3_, final int p_180791_4_, final int mouseXIn, final int mouseYIn) {
            ...
            Gui.drawCenteredString(GuiLanguage.this.fontRendererObj, this.languageMap.get(this.langCodeList.get(entryID)).toString(), (float)(this.width / 2), (float)(p_180791_3_ + 1), 16777215);
