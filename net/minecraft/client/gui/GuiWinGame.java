...
public class GuiWinGame extends GuiScreen
{
    ...
    private void drawWinGameScreen(final int p_146575_1_, final int p_146575_2_, final float p_146575_3_) {
        ...
        f4 *= f4;
        f4 = f4 * 96.0f / 255.0f;
        worldrenderer.pos(0.0, GuiWinGame.height, this.zLevel).tex(0.0, f * f3).color(f4, f4, f4, 1.0f).endVertex();
        worldrenderer.pos(i, GuiWinGame.height, this.zLevel).tex(i * f3, f * f3).color(f4, f4, f4, 1.0f).endVertex();
