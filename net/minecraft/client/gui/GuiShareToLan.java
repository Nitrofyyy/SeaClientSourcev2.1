...
public class GuiShareToLan extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawCenteredString(this.fontRendererObj, I18n.format("lanServer.title", new Object[0]), (float)(GuiShareToLan.width / 2), 50.0f, 16777215);
        Gui.drawCenteredString(this.fontRendererObj, I18n.format("lanServer.otherPlayers", new Object[0]), (float)(GuiShareToLan.width / 2), 82.0f, 16777215);
