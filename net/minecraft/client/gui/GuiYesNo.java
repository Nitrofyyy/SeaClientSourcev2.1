...
public class GuiYesNo extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawCenteredString(this.fontRendererObj, this.messageLine1, (float)(GuiYesNo.width / 2), 70.0f, 16777215);
        int i = 90;
        for (final String s : this.field_175298_s) {
            Gui.drawCenteredString(this.fontRendererObj, s, (float)(GuiYesNo.width / 2), (float)i, 16777215);
