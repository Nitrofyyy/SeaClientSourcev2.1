...
public class GuiSnooper extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawCenteredString(this.fontRendererObj, this.field_146610_i, (float)(GuiSnooper.width / 2), 8.0f, 16777215);
        int i = 22;
        ...
        for (int length = (field_146607_r = this.field_146607_r).length, j = 0; j < length; ++j) {
            ...
            Gui.drawCenteredString(this.fontRendererObj, s, (float)(GuiSnooper.width / 2), (float)i, 8421504);
