...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public void renderPlayerlist(final int width, final Scoreboard scoreboardIn, final ScoreObjective scoreObjectiveIn) {
        ...
        if (this.header != null) {
            list2 = Minecraft.fontRendererObj.listFormattedStringToWidth(this.header.getFormattedText(), width - 50);
            for (final String s : list2) {
                l4 = Math.max(l4, Minecraft.fontRendererObj.getStringWidth(s));
            }
        }
        if (this.footer != null) {
            list3 = Minecraft.fontRendererObj.listFormattedStringToWidth(this.footer.getFormattedText(), width - 50);
            for (final String s2 : list3) {
                l4 = Math.max(l4, Minecraft.fontRendererObj.getStringWidth(s2));
            }
        }
        if (list2 != null) {
            Gui.drawRect(width / 2 - l4 / 2 - 1, k2 - 1, width / 2 + l4 / 2 + 1, k2 + list2.size() * Minecraft.fontRendererObj.FONT_HEIGHT, Integer.MIN_VALUE);
            for (final String s3 : list2) {
                final int i4 = Minecraft.fontRendererObj.getStringWidth(s3);
                Minecraft.fontRendererObj.drawStringWithShadow(s3, (float)(width / 2 - i4 / 2), (float)k2, -1);
                k2 += Minecraft.fontRendererObj.FONT_HEIGHT;
            }
            ++k2;
        }
        ...
        for (int k3 = 0; k3 < l3; ++k3) {
            ...
            if (k3 < list.size()) {
                ...
                if (networkplayerinfo2.getGameType() == WorldSettings.GameType.SPECTATOR) {
                    ...
                    Minecraft.fontRendererObj.drawStringWithShadow(s4, (float)j4, (float)k4, -1862270977);
                }
                else {
                    Minecraft.fontRendererObj.drawStringWithShadow(s4, (float)j4, (float)k4, -1);
                }
        ...
        if (list3 != null) {
            k2 = k2 + i2 * 9 + 1;
            Gui.drawRect(width / 2 - l4 / 2 - 1, k2 - 1, width / 2 + l4 / 2 + 1, k2 + list3.size() * Minecraft.fontRendererObj.FONT_HEIGHT, Integer.MIN_VALUE);
            for (final String s5 : list3) {
                final int j6 = Minecraft.fontRendererObj.getStringWidth(s5);
                Minecraft.fontRendererObj.drawStringWithShadow(s5, (float)(width / 2 - j6 / 2), (float)k2, -1);
                k2 += Minecraft.fontRendererObj.FONT_HEIGHT;
            }
        }
    }
    ...
    protected void drawPing(final int p_175245_1_, final int p_175245_2_, final int p_175245_3_, final NetworkPlayerInfo networkPlayerInfoIn) {
        ...
        this.zLevel += 100.0f;
        if (this.mc.getCurrentServerData().pingToServer <= 10L) {
            Minecraft.fontRendererObj.drawString("§2" + networkPlayerInfoIn.getResponseTime(), p_175245_2_ + p_175245_1_ - 11 - 10 + 30, p_175245_3_, -1);
        }
        else if (this.mc.getCurrentServerData().pingToServer <= 100L) {
            Minecraft.fontRendererObj.drawString("§a" + networkPlayerInfoIn.getResponseTime(), p_175245_2_ + p_175245_1_ - 11 - 10 + 30, p_175245_3_, -1);
        }
        else if (this.mc.getCurrentServerData().pingToServer >= 200L) {
            Minecraft.fontRendererObj.drawString("§c" + networkPlayerInfoIn.getResponseTime(), p_175245_2_ + p_175245_1_ - 11 - 10 + 30, p_175245_3_, -1);
        }
        else if (this.mc.getCurrentServerData().pingToServer >= 300L) {
            Minecraft.fontRendererObj.drawString("§4" + networkPlayerInfoIn.getResponseTime(), p_175245_2_ + p_175245_1_ - 11 - 10 + 30, p_175245_3_, -1);
        }
        this.zLevel -= 100.0f;
    }
        ...
        if (p_175247_1_.getRenderType() == IScoreObjectiveCriteria.EnumRenderType.HEARTS) {
            ...
            if (j > 0) {
                ...
                if (f > 3.0f) {
                    ...
                    if (p_175247_5_ - Minecraft.fontRendererObj.getStringWidth(String.valueOf(s) + "hp") >= p_175247_4_) {
                        s = String.valueOf(s) + "hp";
                    }
                    Minecraft.fontRendererObj.drawStringWithShadow(s, (float)((p_175247_5_ + p_175247_4_) / 2 - Minecraft.fontRendererObj.getStringWidth(s) / 2), (float)p_175247_2_, i2);
                }
            }
        }
        else {
            final String s2 = new StringBuilder().append(EnumChatFormatting.YELLOW).append(i).toString();
            Minecraft.fontRendererObj.drawStringWithShadow(s2, (float)(p_175247_5_ - Minecraft.fontRendererObj.getStringWidth(s2)), (float)p_175247_2_, 16777215);
        }
    }
