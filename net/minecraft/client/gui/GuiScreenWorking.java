...
public class GuiScreenWorking extends GuiScreen implements IProgressUpdate
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        if (this.doneWorking) {
            ...
            if (this.progress > 0) {
                Gui.drawCenteredString(this.fontRendererObj, this.field_146591_a, (float)(GuiScreenWorking.width / 2), 70.0f, 16777215);
                Gui.drawCenteredString(this.fontRendererObj, String.valueOf(this.field_146589_f) + " " + this.progress + "%", (float)(GuiScreenWorking.width / 2), 90.0f, 16777215);
            }
