...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawCenteredString(this.fontRendererObj, this.field_175341_a, (float)(GuiCustomizeWorldScreen.width / 2), 2.0f, 16777215);
        Gui.drawCenteredString(this.fontRendererObj, this.field_175333_f, (float)(GuiCustomizeWorldScreen.width / 2), 12.0f, 16777215);
        Gui.drawCenteredString(this.fontRendererObj, this.field_175335_g, (float)(GuiCustomizeWorldScreen.width / 2), 22.0f, 16777215);
        ...
        if (this.field_175339_B != 0) {
            ...
            tessellator.draw();
            Gui.drawCenteredString(this.fontRendererObj, I18n.format("createWorld.customize.custom.confirmTitle", new Object[0]), (float)(GuiCustomizeWorldScreen.width / 2), 105.0f, 16777215);
            Gui.drawCenteredString(this.fontRendererObj, I18n.format("createWorld.customize.custom.confirm1", new Object[0]), (float)(GuiCustomizeWorldScreen.width / 2), 125.0f, 16777215);
            Gui.drawCenteredString(this.fontRendererObj, I18n.format("createWorld.customize.custom.confirm2", new Object[0]), (float)(GuiCustomizeWorldScreen.width / 2), 135.0f, 16777215);
