...
public class GuiStreamUnavailable extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        int i = Math.max((int)(GuiStreamUnavailable.height * 0.85 / 2.0 - this.field_152323_r.size() * this.fontRendererObj.FONT_HEIGHT / 2.0f), 50);
        Gui.drawCenteredString(this.fontRendererObj, this.field_152324_f.getFormattedText(), (float)(GuiStreamUnavailable.width / 2), (float)(i - this.fontRendererObj.FONT_HEIGHT * 2), 16777215);
        for (final String s : this.field_152323_r) {
            Gui.drawCenteredString(this.fontRendererObj, s, (float)(GuiStreamUnavailable.width / 2), (float)i, 10526880);
