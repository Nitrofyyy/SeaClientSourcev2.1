...
public class GuiTwitchUserMode extends GuiScreen
{
    ...
    public void initGui() {
        ...
        final int j = i - 130;
        this.buttonList.add(new GuiButton(1, i * 0 + j / 2, GuiTwitchUserMode.height - 70, 130, 20, I18n.format("stream.userinfo.timeout", new Object[0])));
        this.buttonList.add(new GuiButton(0, i * 1 + j / 2, GuiTwitchUserMode.height - 70, 130, 20, I18n.format("stream.userinfo.ban", new Object[0])));
        this.buttonList.add(new GuiButton(2, i * 2 + j / 2, GuiTwitchUserMode.height - 70, 130, 20, I18n.format("stream.userinfo.mod", new Object[0])));
        this.buttonList.add(new GuiButton(5, i * 0 + j / 2, GuiTwitchUserMode.height - 45, 130, 20, I18n.format("gui.cancel", new Object[0])));
        this.buttonList.add(new GuiButton(3, i * 1 + j / 2, GuiTwitchUserMode.height - 45, 130, 20, I18n.format("stream.userinfo.unban", new Object[0])));
        this.buttonList.add(new GuiButton(4, i * 2 + j / 2, GuiTwitchUserMode.height - 45, 130, 20, I18n.format("stream.userinfo.unmod", new Object[0])));
        int k = 0;
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawCenteredString(this.fontRendererObj, this.field_152338_i.getUnformattedText(), (float)(GuiTwitchUserMode.width / 2), 70.0f, 16777215);
        int i = 80;
        for (final IChatComponent ichatcomponent : this.field_152332_r) {
