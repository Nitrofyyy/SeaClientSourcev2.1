...
public class GuiStreamOptions extends GuiScreen
{
    ...
    public void initGui() {
        ...
        for (int length = (field_152312_a = GuiStreamOptions.field_152312_a).length, j = 0; j < length; ++j) {
            ...
            if (gamesettings$options.getEnumFloat()) {
                this.buttonList.add(new GuiOptionSlider(gamesettings$options.returnEnumOrdinal(), GuiStreamOptions.width / 2 - 155 + i % 2 * 160, GuiStreamOptions.height / 6 + 24 * (i >> 1), gamesettings$options));
            }
            else {
                this.buttonList.add(new GuiOptionButton(gamesettings$options.returnEnumOrdinal(), GuiStreamOptions.width / 2 - 155 + i % 2 * 160, GuiStreamOptions.height / 6 + 24 * (i >> 1), gamesettings$options, this.field_152318_h.getKeyBinding(gamesettings$options)));
            }
            ++i;
        }
        if (i % 2 == 1) {
        ...
        this.field_152314_s = GuiStreamOptions.height / 6 + 24 * (i >> 1) + 6;
        i += 2;
        ...
        for (int length2 = (field_152316_f = GuiStreamOptions.field_152316_f).length, k = 0; k < length2; ++k) {
            ...
            if (gamesettings$options2.getEnumFloat()) {
                this.buttonList.add(new GuiOptionSlider(gamesettings$options2.returnEnumOrdinal(), GuiStreamOptions.width / 2 - 155 + i % 2 * 160, GuiStreamOptions.height / 6 + 24 * (i >> 1), gamesettings$options2));
            }
            else {
                this.buttonList.add(new GuiOptionButton(gamesettings$options2.returnEnumOrdinal(), GuiStreamOptions.width / 2 - 155 + i % 2 * 160, GuiStreamOptions.height / 6 + 24 * (i >> 1), gamesettings$options2, this.field_152318_h.getKeyBinding(gamesettings$options2)));
            }
            ++i;
        }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawCenteredString(this.fontRendererObj, this.field_152319_i, (float)(GuiStreamOptions.width / 2), 20.0f, 16777215);
        Gui.drawCenteredString(this.fontRendererObj, this.field_152313_r, (float)(GuiStreamOptions.width / 2), (float)this.field_152314_s, 16777215);
        if (this.field_152315_t) {
            Gui.drawCenteredString(this.fontRendererObj, EnumChatFormatting.RED + I18n.format("options.stream.changes", new Object[0]), (float)(GuiStreamOptions.width / 2), (float)(20 + this.fontRendererObj.FONT_HEIGHT), 16777215);
        }
