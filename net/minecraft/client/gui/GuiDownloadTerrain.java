...
public class GuiDownloadTerrain extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawCenteredString(this.fontRendererObj, I18n.format("multiplayer.downloadingTerrain", new Object[0]), (float)(GuiDownloadTerrain.width / 2), (float)(GuiDownloadTerrain.height / 2 - 50), 16777215);
