...
public class GuiMessage extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawCenteredString(this.fontRendererObj, this.messageLine1, (float)(GuiMessage.width / 2), 70.0f, 16777215);
        int i = 90;
        for (final String s : this.listLines2) {
            Gui.drawCenteredString(this.fontRendererObj, s, (float)(GuiMessage.width / 2), (float)i, 16777215);
