...
public enum ShaderParameterBool implements IExpressionBool
{
    ...
    IS_HURT("IS_HURT", 3, "is_hurt"), 
    IS_IN_LAVA("IS_IN_LAVA", 4, "is_in_lava"), 
    IS_IN_WATER("IS_IN_WATER", 5, "is_in_water"), 
    IS_INVISIBLE("IS_INVISIBLE", 6, "is_invisible"), 
    IS_ON_GROUND("IS_ON_GROUND", 7, "is_on_ground"), 
    IS_RIDDEN("IS_RIDDEN", 8, "is_ridden"), 
    IS_RIDING("IS_RIDING", 9, "is_riding"), 
    IS_SNEAKING("IS_SNEAKING", 10, "is_sneaking"), 
    IS_SPRINTING("IS_SPRINTING", 11, "is_sprinting"), 
    IS_WET("IS_WET", 12, "is_wet");
