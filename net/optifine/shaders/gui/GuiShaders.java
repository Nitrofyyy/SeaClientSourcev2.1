...
public class GuiShaders extends GuiScreenOF
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawCenteredString(this.fontRendererObj, String.valueOf(this.screenTitle) + " ", (float)(GuiShaders.width / 2), 15.0f, 16777215);
        ...
        if (i < GuiShaders.width - 5) {
            Gui.drawCenteredString(this.fontRendererObj, s, (float)(GuiShaders.width / 2), (float)(GuiShaders.height - 40), 8421504);
        }
        else {
    ...
    public void drawCenteredString(final String text, final int x, final int y, final int color) {
        Gui.drawCenteredString(this.fontRendererObj, text, (float)x, (float)y, color);
    }
