...
public class GuiExpansionPregen extends GuiPregenBase
{
    GuiScreen prev;
    ...
    public GuiExpansionPregen(final GuiScreen prev) {
    ...
    public PregenTask createTask() {
        ...
        final int maxRadius = ((GuiSlider)this.getIDButton(3)).getValueInt();
        return new PregenTask(4 + this.shapes.getIndex(), this.dimensions.getValue(), centerX, this.centerY, minRadius, maxRadius, this.genTypes.getIndex());
    }
    ...
    public void handleTooltip(final int mouseX, final int mouseY) {
        ...
        this.getIDButton(8).field_146124_l = (this.getTotalGenerationCount() <= 4000000 && min < max);
    }
