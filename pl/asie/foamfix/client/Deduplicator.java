...
public class Deduplicator
{
    ...
    public Deduplicator() {
        this.successfuls = 0;
        this.maxRecursion = 0;
        this.FLOATA_STORAGE = new DeduplicatingStorageTrove<float[]>(HashingStrategies.FLOAT_ARRAY);
        this.FLOATAA_STORAGE = new DeduplicatingStorageTrove<float[][]>(HashingStrategies.FLOAT_ARRAY_ARRAY);
        this.OBJECT_STORAGE = new DeduplicatingStorageTrove(HashingStrategies.GENERIC);
        this.ICT_STORAGE = new DeduplicatingStorageTrove<ItemCameraTransforms>(HashingStrategies.ITEM_CAMERA_TRANSFORMS);
