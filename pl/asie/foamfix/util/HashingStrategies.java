...
public final class HashingStrategies
{
    ...
    static {
        BYTE_ARRAY = (HashingStrategy)new ByteArray();
        FLOAT_ARRAY = (HashingStrategy)new FloatArray();
        FLOAT_ARRAY_ARRAY = (HashingStrategy)new FloatArrayArray();
        INT_ARRAY = (HashingStrategy)new IntArray();
        GENERIC = (HashingStrategy)new ObjectStrategy();
        IDENTITY = (HashingStrategy)new IdentityHashingStrategy();
        ITEM_CAMERA_TRANSFORMS = (HashingStrategy)new ItemCameraTransformsStrategy();
        ITEM_TRANSFORM_VEC3F = (HashingStrategy)new ItemTransformVecStrategy();
    }
    ...
    private static final class ItemCameraTransformsStrategy implements HashingStrategy<ItemCameraTransforms>
    {
        public int computeHashCode(final ItemCameraTransforms object) {
            int hash = 1;
            for (final ItemTransformVec3f transform : ImmutableSet.of((Object)object.field_178356_c, (Object)object.field_181700_p, (Object)object.field_181699_o, (Object)object.field_178354_e, (Object)object.field_178353_d, (Object)object.field_178355_b, (Object[])new ItemTransformVec3f[0])) {
                for (final Vector3f vector : ImmutableSet.of((Object)transform.field_178364_b, (Object)transform.field_178363_d, (Object)transform.field_178365_c)) {
        ...
        public boolean equals(final ItemCameraTransforms o1, final ItemCameraTransforms o2) {
            ...
            return Objects.equals(o1.field_178356_c, o2.field_178356_c) && Objects.equals(o1.field_181700_p, o2.field_181700_p) && Objects.equals(o1.field_181699_o, o2.field_181699_o) && Objects.equals(o1.field_178354_e, o2.field_178354_e) && Objects.equals(o1.field_178353_d, o2.field_178353_d) && Objects.equals(o1.field_178355_b, o2.field_178355_b);
        }
    }
